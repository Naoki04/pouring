...
#    with AsyncRobot(SyncRobot(RTDEController(ip='127.0.0.1'))) as robot:
        ...
        Catch the Pitcher
        """
        print("Go to above Pitcher")
        robot.move_linear((0, 0, 0, 0, 0, 0))
        print("Open Gripper")
        
        print("Moving to Pitcher")
        robot.move_linear((0, 0, 200, 0, 0, 0))
        print("Close Gripper")
        ...
        print("Moving to Pouring Position")
        robot.move_linear((-200, 0, 0, 0, 0, 0))
        
        print("Pouring")
        robot.move_linear((-200, 0, 0, 0, -45, 0))
        robot.move_linear((-200, 0, 0, 0, 0, 0))
        time.sleep(1000000)
        ...
        robot.async_result()
        print("Moving to second waypoint ...")
        robot.async_move_linear((100, 100, 0, 0, f0, 0))
        print("Getting on with something else while command completes ...")
        robot.async_result()
        robot.blend_radius = 0
        print("Moving to final destination ...")
